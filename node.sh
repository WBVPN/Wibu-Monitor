...
# ==========================================
# 2. KONFIGURASI NODE (Ganti saat install)
# ==========================================
# URL Master diisi IP Master (contoh: http://103.253.245.123:5000/api/report)
MASTER_API_URL="http://IP_MASTER_KAMU:5000/api/report"
NODE_NAME="NODE-02"
